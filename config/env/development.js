 ...
 */
const url = require('get-url-origin');
module.exports = {
    ...
    datastores: {
        ...
        default: {
            ...
            host: 'localhost',
            port: 27017,
            database: process.env.DHR_DATABASE_NAME
        },
    ...
    secret: process.env.DHR_SECRET,
    apiUrl: process.env.DHR_API_URL,
    webUrl: process.env.DHR_WEB_URL,
    uploadUrl: process.env.DHR_UPLOAD_URL,
    uploadDir: process.env.DHR_UPLOAD_DIR,
    formatDateTime: 'YYYY-MM-DD HH:mm:ss',
    msDataUser: 'LEMONSYS',
    msDataApp: process.env.DHR_DB_NAME,
    msServer: process.env.DHR_DB_SERVER,
    msUser: process.env.DHR_DB_USER,
    msPass: process.env.DHR_DB_PASS,
    authFCM: process.env.DHR_FCM_KEY,
    apiKeyPDF : process.env.DHR_PDF_KEY
};
